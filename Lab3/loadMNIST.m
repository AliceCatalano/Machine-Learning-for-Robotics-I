...
if which
  X = loadMNISTImages('MNISTdataset/t10k-images.idx3-ubyte')';
  T = loadMNISTLabels('MNISTdataset/t10k-labels.idx1-ubyte');
else
  X = loadMNISTImages('MNISTdataset/train-images.idx3-ubyte')';
  T = loadMNISTLabels('MNISTdataset/train-labels.idx1-ubyte');
end
T(T==0)=10;
